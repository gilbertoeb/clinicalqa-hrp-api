...
INPUT_PATH = "data/raw/testing/real_qa_test.jsonl"  # 20-note eval set
PREDS_PATH = "results/real_predictionsv3.jsonl"
METRICS_PATH = "results/real_eval_resultsv3.json"
