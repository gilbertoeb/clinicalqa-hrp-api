...
INPUT_PATH = "data/processed/mixed_eval_synthea_and_real.jsonl"
PREDS_PATH = "results/real_predictionsv4_mixed_eval.jsonl"
METRICS_PATH = "results/real_eval_resultsv4_mixed_eval.json"
